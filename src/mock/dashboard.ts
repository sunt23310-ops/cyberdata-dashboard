...
export const pieChartData = [
  ...
  { category: '定妆散粉', value: 1, percentage: 1 },
  { category: '定妆喷雾', value: 1, percentage: 1 },
  { category: '仪器', value: 1, percentage: 1 },
  { category: '遮瑕', value: 1, percentage: 1 },
  { category: '腮红', value: 1, percentage: 1 },
  { category: '套组', value: 1, percentage: 1 },
  { category: '眼影', value: 1, percentage: 1 },
  { category: '修容', value: 1, percentage: 1 },
  { category: '眉笔', value: 1, percentage: 1 },
  { category: '工具', value: 1, percentage: 1 },
  { category: '睫毛膏/眼线笔', value: 1, percentage: 1 },
]
...
export const categoryData = [
  ...
  { name: '定妆散粉', count: 9, percentage: 1, color: '#2ECC71' },
  { name: '定妆喷雾', count: 7, percentage: 1, color: '#E74C3C' },
  { name: '仪器', count: 7, percentage: 1, color: '#34495E' },
  { name: '遮瑕', count: 6, percentage: 1, color: '#D35400' },
  { name: '腮红', count: 4, percentage: 1, color: '#16A085' },
  { name: '套组', count: 4, percentage: 1, color: '#27AE60' },
  { name: '眼影', count: 2, percentage: 1, color: '#2980B9' },
  { name: '修容', count: 2, percentage: 1, color: '#8B4513' },
  { name: '眉笔', count: 2, percentage: 1, color: '#C0392B' },
  { name: '工具', count: 2, percentage: 1, color: '#7F8C8D' },
  { name: '睫毛膏/眼线笔', count: 1, percentage: 1, color: '#BDC3C7' },
]
